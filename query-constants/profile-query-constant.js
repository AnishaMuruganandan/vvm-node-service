var profileQueryConst = {
  ...
  getProfileBasicDetailsQuery: "select * from profile_basic_details where profile_basic_id in (select profile_basic_id FROM login_details)",
  ...
  getTenProfileBasicDetailsQuery: "select * from profile_basic_details where profile_basic_id in (select profile_basic_id FROM login_details) LIMIT 10",
